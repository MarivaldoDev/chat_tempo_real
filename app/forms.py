...
class LoginForm(forms.Form):
    username = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"placeholder": "Digite seu nome de usuário...", "required": True}
        ),
    )
    password = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"placeholder": "Digite sua senha...", "required": True}
        ),
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "email": forms.EmailInput(
                attrs={"name": "email", "placeholder": "Seu E-mail", "required": True}
            ),
            "password": forms.PasswordInput(
                attrs={"name": "password", "placeholder": "Sua Senha", "required": True}
            ),
            ...
            "bio": forms.Textarea(
                attrs={"name": "bio", "placeholder": "Sobre você (Opcional)", "rows": 3}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"name": "name", "placeholder": "Nome da sala", "required": True}
            ),
