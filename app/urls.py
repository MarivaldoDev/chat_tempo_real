...
from .views import room_views, user_views
...
urlpatterns = [
    ...
    path('register_update/<int:id>/', user_views.register_update, name='register_update'),
    ...
    path('myprofile/deletar/<int:id>/', user_views.delete_profile, name='delete_profile'),
